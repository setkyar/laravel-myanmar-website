...
<html lang="en">
  <head>
    ...
    <link rel="icon" href="{{ asset('assets/img/lm-icon.ico') }}" type="image/x-icon" />
    <link rel="shortcut icon" href="{{ asset('assets/img/lm-icon.ico') }}" type="image/x-icon" />

    <title>{{ isset($pageTitle) ? $pageTitle . " - Laravel Myanmar" : 'Laravel Myanmar' }}</title>
